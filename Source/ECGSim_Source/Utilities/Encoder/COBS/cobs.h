 ...
 * @date 25-May-2022
 * @brief This file includes the declarations of functions for performing COBS encoding and decoding
 *
 * @attention COPYRIGHT(c) 2010 Craig McQueen
 */

#ifndef ENCODER_COBS_COBS_H_
#define ENCODER_COBS_COBS_H_
